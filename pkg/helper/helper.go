...
var requiredEnv = map[string]string{
	"APP_ENV": "DEV,PRODUCTION", "X_MAX": "number, above 0", "Y_MAX": "number, above 0", "IO_THREADS": "number, above 0", "VALKEY_HOST": "e.g. 127.0.0.1:6379", "VALKEY_PASSWORD": "e.g. password123", "PORT": "port num,e.g. 8081, must be set in ui/.env ( VITE_APP_URL=localhost:8081 ) too", "VALKEY_MAX_MEMORY": "e.g. 256mb, 1gb, 2gb", "MASTER_API_KEY": "Admin api key"}
